    ...
    private val bluetoothStateReceiver = BluetoothStateReceiver { isConnected, bluetoothDevice ->
        if (bluetoothAdapter?.bondedDevices?.contains(bluetoothDevice) == true) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                _errors.emit("Can't connect to no-paired device.")
            }
        }
    }
...
//            println("start discovery=no BLUETOOTH_CONNECT==")
//            return
//        }
        context.registerReceiver(
            foundDeviceReceiver,
...
//            }
            ...
            while (shouldLoop) {
                currentClientSocket = try {
                    ...
                    shouldLoop = false
                    emit(ConnectionResult.Error("accept failed"))
                    null
                }
...
//        }
    ...
    companion object {
        const val SERVICE_UUID = "bfdd217e-8260-4ac0-3447-d8445c054ec9"
    }
}